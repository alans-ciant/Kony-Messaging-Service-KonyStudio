...
function pushSubscription(chkbox) {
    if (chkbox["selectedKeys"] == null) audiencePushSubs = false;
    else audiencePushSubs = true;
}

function smsSubscription(chkbox) {
    if (chkbox["selectedKeys"] == null) audienceSmsSubs = false;
    else audienceSmsSubs = true;
}

function emailSubscription(chkbox) {
    if (chkbox["selectedKeys"] == null) audienceEmailSubs = false;
    else audienceEmailSubs = true;
}